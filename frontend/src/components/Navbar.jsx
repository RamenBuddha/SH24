...
const Navbar = () => {
    return (
        ...
        <span className="rounded-sm px-6 py-2 bg-pink-200 hover:cursor-pointer hover:transition duration-350 ease-in-out hover:text-black font-bold text-white text-left">Export</span>
        </header>        
        </>
    )
}
